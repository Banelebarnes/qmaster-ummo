...
import com.heinrichreimersoftware.singleinputform.steps.TimePickerStep;
...
public class QCreateQForm extends SingleInputFormActivity implements QMasterListener
{
    ...
    protected List<Step> getSteps(Context context)
    {
        ...
        steps.add(
                new TimePickerStep(context, DATA_TIME_FRAME_START, 150, 180, R.string.qTimeFarmeStart, R.string.qTimeFrameStart_error, R.string.qTimeFrameStart_details, new TimePickerStep.StepChecker() {
                    @Override
        ...
        steps.add(
                new TimePickerStep(context, DATA_TIME_FRAME_END, 150, 180, R.string.qTimeFarmeEnd, R.string.qTimeFrameStart_error, R.string.qTimeFrameEnd_details, new TimePickerStep.StepChecker() {
                    @Override
                    public boolean check(int progress)
                    {
                        return progress >= 160;
