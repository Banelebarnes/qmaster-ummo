...
public class NavDrawerActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("HeaderCount","String.valueOf(mNavigationView.getHeaderCount())");
    ...
    private void setUpNavDrawer() {
        ...
        ((TextView)findViewById(R.id.nametv)).setText(new QMaster(this).getName());
        Log.e("Name",new QMaster(this).getName());
