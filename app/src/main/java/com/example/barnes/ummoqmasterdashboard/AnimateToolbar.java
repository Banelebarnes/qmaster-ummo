...
public class AnimateToolbar extends AppCompatActivity implements View.OnClickListener, QMasterListener
{
    ...
    private void showMultiChoiceListAlertDialog()
    {
        ...
        createAlertDialogBuilder().setTitle("Manage Queue").setMultiChoiceItems(list, new boolean[]{false, false, false},
                ...
                .setPositiveButton("Create new queue", new ButtonClickedListener(""))
                .show();
    }
